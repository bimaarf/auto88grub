...
class UpdateColorPage extends StatefulWidget {
  ...
  @override
  _UpdateColorPageState createState() => _UpdateColorPageState();
}
  ...
  Future<void> updateColor() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/api/color/update/${widget.colorId}'),
        headers: headers,
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Color updated err'),
            duration: Duration(seconds: 2),
          ),
        );
        print('Failed to update Color: ${response.statusCode}');
      }
    } catch (e) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: _isLoading ? null : updateColor,

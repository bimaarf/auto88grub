...
use App\Filament\Resources\Car\FuelResource\Pages;
...
class FuelResource extends Resource
{
    ...
    protected static ?string $slug = 'car/fuels';
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->unique(Fuel::class, 'name', ignoreRecord: true),
            ])->columns(1);
    }

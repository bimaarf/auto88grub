...
use App\Filament\Resources\Car\GearResource\Pages;
...
class GearResource extends Resource
{
    ...
    protected static ?string $slug = 'car/gears';
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->unique(Gear::class, 'name', ignoreRecord: true),
            ])->columns(1);
    }

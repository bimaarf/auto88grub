      ...
      {(function (rows, i, len) {
        while (++i <= len) {
          rows.push(
            <div
              key={i}
              className="block overflow-hidden active:scale-90 hover:scale-95 cursor-pointer duration-300 w-full max-w-[32rem] rounded-lg bg-base-200 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">

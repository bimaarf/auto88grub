...
export const TestimonyList = ({ getTestimony }) => {
  return (
    <div className="bg-base-100 bg-opacity-10 backdrop-blur-smpb-32">
      {getTestimony.data.map((item, key) => (
        <div key={key}>
          <div className="collapse fade-in-left select-none whitespace-nowrap outline-none overflow-x-auto collapse-arrow bg-base-100 hover:bg-base-200 mt-4">
            <input
              type="checkbox"
              defaultChecked
              name="my-accordion-2"
              ...
              <div className="lg:flex space-y-4 lg:space-y-0 justify-start xl:max-w-screen-lg items-center">
                <div className="flex gap-2 lg:w-1/3 justify-start items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-normal text-pretty lowercase">
                      {item.testimoni_at}
                    </p>
                  </div>
                </div>
            ...
            <div className="collapse-content">
              <div className="flex justify-center items-center space-y-2 mt-4 border-t border-base-300 pt-4">

        ...
        <section
          ...
          <section
            ...
            <div id="tabs" className="flex justify-between">
              <button
                onClick={() => navRedirect("/")}
                className="w-full focus:text-red-500 hover:text-red-500 text-pretty justify-center inline-block text-center pt-2 pb-1">
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 42 42"
              ...
              <button className="w-full focus:text-red-500 hover:text-red-500 text-pretty justify-center inline-block text-center pt-2 pb-1">
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 25 25"
              ...
              <button className="w-full focus:text-red-500 hover:text-red-500 text-pretty justify-center inline-block text-center pt-2 pb-1">
                <label className="swap -mt-3 swap-rotate hover:bg-pink-600 hover:bg-opacity-25 rounded-xl p-1 scale-75 active:scale-90 duration-200">
                  ...
                  {/* sun icon */}
                  <svg
                    className="swap-on fill-current w-11 h-11 inline-block"
                  ...
                  {/* moon icon */}
                  <svg
                    className="swap-off fill-current w-11 h-11 inline-block"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24">

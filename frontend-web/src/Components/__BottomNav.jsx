...
export const BottomNav = ({
  ...
  return (
    <>
      <div class="w-full relative md:hidden z-50">
        <section
          id="bottom-navigation"
          class="md:hidden block fixed inset-x-0 bottom-0 z-10 bg-base-100 shadow">
          <section
            id="bottom-navigation"
            class="block fixed inset-x-0 bottom-0 z-10 bg-base-100 shadow">
            <div id="tabs" class="flex justify-between">
              <button
                onClick={() => navRedirect("/")}
                class="w-full focus:text-red-500 hover:text-red-500 text-pretty justify-center inline-block text-center pt-2 pb-1">
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 42 42"
              ...
              <button class="w-full focus:text-red-500 hover:text-red-500 text-pretty justify-center inline-block text-center pt-2 pb-1">
                <svg
                  width="25"
                  height="25"
                  viewBox="0 0 25 25"
              ...
              <button class="w-full focus:text-red-500 hover:text-red-500 text-pretty justify-center inline-block text-center pt-2 pb-1">
                ...
                <span
                  class="tab tab-explore block text-xs"

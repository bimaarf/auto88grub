...
export const CarouselBlogSkeleton = () => {
  return (
    <>
                ...
                while (++i <= len) {
                  rows.push(
                    <div
                      ...
                      <div className="p-6">
                        <p className="skeleton h-4 w-full mt-2"></p>
                        <p className="skeleton h-4 w-full mt-2"></p>
                        <p className="skeleton h-4 w-40 mt-2"></p>
                        <p className="skeleton h-4 w-full mt-2"></p>
                        <div className="flex justify-between items-center text-xs text-orange-500 mt-2">
                          <div className="flex justify-start items-center gap-1">
                            <p className="skeleton h-3 w-10 mt-2"></p>
                            <p className="skeleton h-3 w-40 mt-2"></p>
                          </div>
                          <p className="skeleton h-3 w-10 mt-2"></p>
                        </div>
                      </div>
              ...
              {(function (rows, i, len) {
                while (++i <= len) {
                  rows.push(
                    <div
                      key={i}
                      className="block active:scale-95 cursor-pointer duration-300 w-full max-w-[32rem] bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                      <div className="relative overflow-hidden bg-cover flex bg-no-repeat justify-center items-center">
                        <img
                          className="skeleton animate-ping"
                          src="https://www.peacemakersnetwork.org/wp-content/uploads/2019/09/placeholder.jpg"

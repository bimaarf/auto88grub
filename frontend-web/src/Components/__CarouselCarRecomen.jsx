          ...
          {(function (rows, i, len) {
            while (++i <= len) {
              rows.push(
                <div
                  key={i}
                  className="block border-base-200 border hover:border-red-500 active:scale-95 cursor-pointer duration-300 w-full mb-3 max-w-[32rem] rounded-lg bg-base-300/10 border-base-200">
